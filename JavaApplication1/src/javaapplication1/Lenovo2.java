 ...
 * @author crazymouse
 */
public class Lenovo2 extends javax.swing.JFrame {

    /** Creates new form Lenovo2 */
    public Lenovo2() {
        initComponents();
        this.setLocationRelativeTo(null);
        String text="<html>";
        text+="Lenovo 2022 Newest Ideapad 3\n" +
        "Laptop, 15.6\" HD Touchscreen,\n" +
        "11th Gen Intel Core i3-1115G4\n" +
        "Processor, 8GB DDR4 RAM,\n" +
        "256GB PCIe NVMe SSD, HDMI,\n" +    
        "Webcam, Wi-Fi 5, Bluetooth,\n" +
        "Windows 11 Home, Almond<br>";
        lbl_1.setText(text);
        String text2="<html>";
        text2+="2022 Newest Lenovo Ideapad 3\n" +
        "Laptop, 15.6\" HD Touchscreen,\n" +
        "11th Gen Intel Core i3-1115G4\n" +
        "Processor,\n" +
        "8GB DDR4 RAM, 256GB PCIe\n" +
        "NVMe SSD, HDMI, Webcam, Wi-Fi\n" +
        "5, Bluetooth,\n" +
        "Windows 11 Home, Platinum Grey<br>";
        lbl_2.setText(text2);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (6).png")); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (7).png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lenovo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
