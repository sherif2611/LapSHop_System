 ...
 * @author crazymouse
 */
public class Samsung2 extends javax.swing.JFrame {

    /**
     * Creates new form Samsung2
     */
    public Samsung2() {
        initComponents();
        this.setLocationRelativeTo(null);
        String text="<html>";
        text+="SAMSUNG 15.6” Galaxy Book2 Pro Laptop Computer, i5 / 8GB / 512GB, 12th Gen Intel Core Processor, Evo Certified,\n" +
        " Lightweight, 2022 Model, Graphite <br>";
        lbl_1.setText(text);
        String text2="<html>";
        text2+="SAMSUNG 2022 14” FHD(1920 x 1080) Laptop, Windows 11 OS, Qualcomm Octa Core Snapdragon Processor 2.55GHz, 4GB LPDDR4x, 64GB SSD (Renewed)<br>";
        lbl_2.setText(text2);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\samsung3.png")); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (7).jpg")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Samsung2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
