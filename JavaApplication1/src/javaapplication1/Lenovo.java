 ...
 * @author crazymouse
 */
public class Lenovo extends javax.swing.JFrame {
    ...
    public Lenovo() {
        ...
        String text="<html>";
        text+="Lenovo IdeaPad 3i Laptop,\n" +
        "17.3\" HD+ Display, 11th Gen Intel\n" +
        "Core i5-1135G7, Intel Iris Xe\n" +
        "Graphics, 20GB RAM,\n" +
        "512GB PCIe SSD, WiFi, Webcam,\n" +
        "Fingerprint Reader, Windows 11\n" +
        "Home, Gray<br>";
        lbl_1.setText(text);
        String text2="<html>";
        text2+="Lenovo 2022 Newest Ideapad 3\n" +
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (6).jpg")); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (5).png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lenovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
