...
public class Mac extends javax.swing.JFrame {
    ...
    public Mac() {
        ...
        String text="<html>";
        text+="2021 Apple MacBook Pro (16-\n" +
        "inch, Apple M1 Max chip with\n" +
        "10‑ core CPU and 32‑ core GPU,\n" +
        "64GB RAM, 2TB SSD) - Space Gray\n" +
        "- Z14X000HQ<br>";
        lbl_1.setText(text);
        String text2="<html>";
        text2+="2021 Apple MacBook Pro (14-\n" +
        "inch, Apple M1 Pro chip with\n" +
        "8‑ core CPU and 14‑ core GPU,\n" +
        "16GB RAM,\n" +
        "512GB SSD) - Space Gray<br>";
         lbl_2.setText(text2);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (2).jpg")); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon("E:\\java\\JavaApplication1\\imgs\\My project (3).jpg")); // NOI18N
